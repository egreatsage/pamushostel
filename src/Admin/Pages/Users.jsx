  ...
  <div>
    ...
    <header className='shadow-md'>
      ...
      <h1 className='text-start font-semibold text-md pl-4 my-4'>Add a User</h1>
        ...
        color='teal' type='text' className='text-black' variant='standard' label='Email' /></div>
       
         <div className='my-3'><Input color='teal' type='text' className='text-black' variant='standard' label='Password'
       value={password}
